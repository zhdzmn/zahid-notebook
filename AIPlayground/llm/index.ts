import { ChatSession, Content, FunctionCall, FunctionResponse, FunctionResponsePart, GenerativeModel, HarmBlockThreshold, HarmCategory, Part, SchemaType, Tool, VertexAI } from "@google-cloud/vertexai";
...
export class GeminiLLM extends LLMInterface {
  ...
  async *sendMessage(prompt: Content): AsyncGenerator<string> {
